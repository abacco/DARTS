...
import windowCommitConstruction.testSmellPanel.ITSmellPanel;
...
public class IgnoredTestCP extends JPanel implements ListSelectionListener{
    private ArrayList<IgnoredTestInfo> classesWithIgnoredTest;
    ...
    public IgnoredTestCP(ArrayList<IgnoredTestInfo> listIT, Project project) {
        ...
        if(!listIT.isEmpty()){
            ...
            classList.addListSelectionListener((ListSelectionListener) this);
            ...
            secondSplitPane = new ITSmellPanel(classesWithIgnoredTest.get(0), project, this);
    ...
    protected void updateSmellPanel (int index) {
        ...
        if(index == -1 && model.getSize() == 0){
            ...
            iti = (IgnoredTestInfo) classList.getModel().getElementAt(0);
        } else {
            iti = (IgnoredTestInfo) classList.getModel().getElementAt(index);
        }
        secondSplitPane = new ITSmellPanel((IgnoredTestInfo) iti, project, this);
    ...
    public void doAfterRefactor(){
        ...
        classesWithIgnoredTest.remove(index);
        model.remove(index);
